...
- [ ] **O-9 — Identité Oyan** — nom (D18) et identité visuelle v1 « Argile » (D19) actés et consignés dans `docs/brand.md` §12-13 le 25/09/2026. Reste à faire :
  ...
  6. ✅ Fiche d'une boucle selon la charte (25/09/2026, 4805885) : libellé mono capitales, distance en Hanken Light 48 px, repères « D+ · durée · en ville », bouton GPX juste après le profil, alternatives puis « Tous les chiffres » ; vitesse moyenne retirée (chiffre de performance, `brand.md` §6).
